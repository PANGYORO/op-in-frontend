                          ...
                          <div className='grid grid-rows-2 items-center'>
                            ...
                            <div className='flex flex-row grid grid-cols-2'>
                              ...
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="items-center mx-4 px-4 py-5 text-md font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 "
                              >visit</a>
                            </div>
                          </div>
                          <div className='grid grid-rows-2 items-center'>
