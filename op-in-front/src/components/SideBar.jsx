...
export default function Sidebar() {
  return (
    <div>
      <div className="relative bg-white dark:bg-gray-800 shadow-lg rounded-2xl">
          ...
          <div className="h-screen w-72">
            ...
            <nav className="mt-10 px-6 ">
              ...
              >
                ...
                <span className="mx-4 text-lg font-normal">My Page</span>
                <span className="flex-grow text-right"></span>
              </a>
              ...
              >
                ...
                <span className="mx-4 text-lg font-normal">Repository</span>
              ...
              >
                ...
                <span className="mx-4 text-lg font-normal">Education</span>
                <span className="flex-grow text-right"></span>
              </a>
              ...
              >
                ...
                <span className="mx-4 text-lg font-normal">Events</span>
                <span className="flex-grow text-right"></span>
              </a>
            </nav>
