...
<div class="w-full p-4 mb-6 bg-white rounded-lg shadow dark:bg-gray-800 sm:inline-block">
        <div class="flex items-start text-left">
          
        <div class="flex-shrink-0">
            <div class="relative inline-block">
                <a href="#" class="relative block">
                <img alt="profil" src={DefaultImg} class="mx-auto object-cover rounded-full h-16 w-16 "/>
              </a>
              {/* 아래 뱃지 */}
        ...
        <div class="ml-6">
            ...
            <div class="mt-3">
                <p class="max-w-2xl mt-1 dark:text-white">
...
<form class="flex flex-col justify-center w-3/4 max-w-sm space-y-3 md:flex-row md:w-full md:space-x-3 md:space-y-0">
    <div class=" relative w-full">
        <input type="text" id="&quot;form-subscribe-Subscribe" class=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" placeholder="내용을 입력해 주세요"/>
        </div>
