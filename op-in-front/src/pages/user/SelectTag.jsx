      ...
      <div className="h-24 w-32">
        ...
        >
          <div>
            <input
              onClick={(event) => {
                props.handleTopic(event.target.value);
              }}
              type="checkbox"
              id={props.name}
              value={props.name}
      ...
      <div className="h-24 w-32">
        ...
        >
          <div>
            <input
              onClick={(event) => {
                props.handleLan(event.target.value);
              }}
              type="checkbox"
              id={props.name}
              value={props.name}
...
function SelectTag() {
  ...
  const javaSvg = (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" height="50" width="50">
  ...
  const tsSvg = (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" height="50" width="50">
  ...
  return (
    <div className="mx-44">
      ...
      />
      <div className="py-8">
        <div className="text-3xl">HOT Topic</div>
      </div>
      ...
      <div className="py-8">
        <div className="text-3xl">HOT Language</div>
      </div>
      ...
      <div id="tagButton" className="grid grid-cols-4 justify-center gap-4">
        <div>
          <button onClick={() => setJoyride({ run: true, steps: steps })}>Start Tour</button>
        </div>
        <div></div>
        <div></div>
