...
const Pagination = () => {
  return (
    <nav className="grid grid justify-center py-3">
      <ul className="inline-flex items-center -space-x-px">
        ...
        <li>
          <a href="#" className="px-3 py-2 leading-tight text-blue-600 border border-blue-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">3</a>
        </li>
        <li>
