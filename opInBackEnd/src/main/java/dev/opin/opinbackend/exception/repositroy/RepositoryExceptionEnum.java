package dev.opin.opinbackend.exception.repositroy;
...
public enum RepositoryExceptionEnum {
	...
	REPOSITORY_POST_LIKE_SAVE_EXCEPTION(HttpStatus.BAD_REQUEST, "M0016", "이미 좋아요 를 하고 있는 포스트입니다."),
	REPOSITORY_QNA_EXIST_EXCEPTION(HttpStatus.BAD_REQUEST, "M0017", "QNA 가 존재하지 않습니다.");
